...
class PointageRepositoryTest extends MongoTestContainer {
    ...
    void should_detect_recent_device_usage() {
        ...
        p.setDate(LocalDate.of(2025, 12, 10));
    ...
    void should_count_by_date() {
        ...
        p1.setDate(LocalDate.of(2025, 12, 10));

        Pointage p2 = new Pointage();
        p2.setDate(LocalDate.of(2025, 12, 10));

        repository.saveAll(List.of(p1, p2));

        Long count = repository.countByDate(LocalDate.of(2025, 12, 10));
