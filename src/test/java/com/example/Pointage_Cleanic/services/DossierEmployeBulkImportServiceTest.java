...
class DossierEmployeBulkImportServiceTest {
    ...
    void setUp() {
        ...
        when(mapper.toEntity(any(com.example.Pointage_Cleanic.Dto.DossierEmployeDto.class)))
                .thenAnswer(inv -> {
                    var dto = (com.example.Pointage_Cleanic.Dto.DossierEmployeDto) inv.getArgument(0);
