...
class GrilleSalarialeControllerTest {
    ...
    void get_all_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/grille-salariale"))
    ...
    void get_by_id_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/grille-salariale/cat-1"))
                .andExpect(status().isOk())
    ...
    void create_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/paie/grille-salariale")
    ...
    void update_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/grille-salariale/cat-1")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void delete_ok() throws Exception {
        ...
        mockMvc.perform(delete("/api/paie/grille-salariale/cat-1"))
