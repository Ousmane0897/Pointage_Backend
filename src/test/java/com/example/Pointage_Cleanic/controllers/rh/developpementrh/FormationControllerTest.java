...
class FormationControllerTest {
    ...
    void create_formation_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/formations")
    ...
    void search_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/formations"))
    ...
    void get_by_id_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/formations/f-1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.titre").value("Sécurité"));
    }
    ...
    void update_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/formations/f-1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(dto)))
                .andExpect(status().isOk())
    ...
    void delete_ok() throws Exception {
        ...
        mockMvc.perform(delete("/api/developpement-rh/formations/f-1"))
    ...
    void add_session_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/formations/f-1/sessions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(dto)))
                .andExpect(status().isCreated())
    ...
    void list_sessions_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/formations/f-1/sessions"))
                .andExpect(status().isOk())
    ...
    void add_participant_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/formations/sessions/s-1/participants")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(dto)))
                .andExpect(status().isCreated())
    ...
    void marquer_presence_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/formations/participations/p-1/presence")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void add_evaluation_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/formations/sessions/s-1/evaluations")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(dto)))
                .andExpect(status().isCreated())
