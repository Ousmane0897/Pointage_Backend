...
class BulletinPaieControllerTest {
    ...
    void get_historique_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/bulletins/historique")
    ...
    void get_all_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/bulletins"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id").value("bp-1"));
    }
    ...
    void get_by_id_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/bulletins/bp-1"))
                .andExpect(status().isOk())
    ...
    void update_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/bulletins/bp-1")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void delete_ok() throws Exception {
        ...
        mockMvc.perform(delete("/api/paie/bulletins/bp-1"))
    ...
    void valider_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/bulletins/bp-1/valider")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void payer_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/bulletins/bp-1/payer"))
                .andExpect(status().isOk())
    ...
    void annuler_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/bulletins/bp-1/annuler")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void export_pdf_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/bulletins/bp-1/pdf"))
                .andExpect(status().isOk())
