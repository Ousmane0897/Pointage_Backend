...
class DeclarationSocialeControllerTest {
    ...
    void generer_ipres_mensuelle_avec_periode_iso() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/ipres").param("periode", "2026-04"))
    ...
    void generer_ipres_mensuelle_avec_mois_annee() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/ipres")
    ...
    void generer_ipres_annuelle_sans_mois() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/ipres").param("annee", "2026"))
                .andExpect(status().isOk())
    ...
    void generer_css_mensuelle_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/css").param("periode", "2026-04"))
                .andExpect(status().isOk())
    ...
    void get_all_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales"))
                .andExpect(status().isOk())
    ...
    void get_by_id_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/d-1"))
                .andExpect(status().isOk())
    ...
    void transmettre_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/paie/declarations-sociales/d-1/transmettre")
    ...
    void export_pdf_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/export/pdf").param("id", "d-1"))
                .andExpect(status().isOk())
    ...
    void export_excel_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/paie/declarations-sociales/export/excel").param("id", "d-1"))
                .andExpect(status().isOk())
