...
class EvaluationPeriodiqueControllerTest {
    ...
    void create_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/evaluations")
    ...
    void search_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/evaluations"))
    ...
    void auto_evaluer_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/evaluations/ev-1/auto-evaluer")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void evaluer_manager_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/evaluations/ev-1/evaluer-manager")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void valider_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/evaluations/ev-1/valider")
                        .contentType(MediaType.APPLICATION_JSON)
