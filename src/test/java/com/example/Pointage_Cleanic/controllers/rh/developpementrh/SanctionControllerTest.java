...
class SanctionControllerTest {
    ...
    void create_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/developpement-rh/sanctions")
    ...
    void search_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/sanctions"))
    ...
    void historique_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/sanctions/historique/emp-1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id").value("sa-1"))
    ...
    void changer_statut_ok() throws Exception {
        ...
        mockMvc.perform(put("/api/developpement-rh/sanctions/sa-1/statut")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void alertes_recidive_ok() throws Exception {
        ...
        mockMvc.perform(get("/api/developpement-rh/sanctions/alertes-recidive"))
                .andExpect(status().isOk())
